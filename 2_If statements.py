...
'''
 Here, the computer came to the first IF and it evaluated to "true", it then evaluated each successive IF until it was done.
...
'''
 I have set up 3 variables that are currently static, but will eventually be pulled from either
...
'''
 Next, make a new IF statement that checks to see if the current time is outside our "time window"
...
'''
 ...
 Uncomment the code below and run it. Then play around with it for a bit until you feel comfortable.
 '''
